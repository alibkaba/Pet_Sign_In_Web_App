<?php
//MySQL
$msqldns = "mysql:host=localhost;dbname=djkabau1_petsignin";
$msqlu = "djkabau1_admin";
$msqlp = "v,w_v;cpxzag";
$PDOconn = new PDO($msqldns, $msqlu, $msqlp);
try {
...
//DB2
$db2dsn = "jdbc:db2://75.126.155.153:50001/SQLDB:securityMechanism=9";
$db2u = "akaba@us.ibm.com";
$db2p = "Lwiogn4s.12";
